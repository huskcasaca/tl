...
type IAvailableEffect interface {
	tl.Object
	_IAvailableEffect()
}

var (
	_ IAvailableEffect = (*AvailableEffect)(nil)
)
...
func (*AvailableEffect) _IAvailableEffect() {}
...
type IBotBusinessConnection interface {
	tl.Object
	_IBotBusinessConnection()
}

var (
	_ IBotBusinessConnection = (*BotBusinessConnection)(nil)
)
...
func (*BotBusinessConnection) _IBotBusinessConnection() {}
...
type IBotPreviewMedia interface {
	tl.Object
	_IBotPreviewMedia()
}

var (
	_ IBotPreviewMedia = (*BotPreviewMedia)(nil)
)
...
func (*BotPreviewMedia) _IBotPreviewMedia() {}

type IBroadcastRevenueBalances interface {
	tl.Object
	_IBroadcastRevenueBalances()
}

var (
	_ IBroadcastRevenueBalances = (*BroadcastRevenueBalances)(nil)
)
...
func (*BroadcastRevenueBalances) _IBroadcastRevenueBalances() {}

type IBroadcastRevenueTransaction interface {
	tl.Object
	_IBroadcastRevenueTransaction()
}

var (
	_ IBroadcastRevenueTransaction = (*BroadcastRevenueTransactionProceeds)(nil)
	_ IBroadcastRevenueTransaction = (*BroadcastRevenueTransactionWithdrawal)(nil)
	_ IBroadcastRevenueTransaction = (*BroadcastRevenueTransactionRefund)(nil)
)
...
func (*BroadcastRevenueTransactionProceeds) _IBroadcastRevenueTransaction() {}
...
func (*BroadcastRevenueTransactionWithdrawal) _IBroadcastRevenueTransaction() {}
...
func (*BroadcastRevenueTransactionRefund) _IBroadcastRevenueTransaction() {}

type IBusinessAwayMessage interface {
	tl.Object
	_IBusinessAwayMessage()
}

var (
	_ IBusinessAwayMessage = (*BusinessAwayMessage)(nil)
)
...
func (*BusinessAwayMessage) _IBusinessAwayMessage() {}

type IBusinessAwayMessageSchedule interface {
	tl.Object
	_IBusinessAwayMessageSchedule()
}

var (
	_ IBusinessAwayMessageSchedule = (*BusinessAwayMessageScheduleAlways)(nil)
	_ IBusinessAwayMessageSchedule = (*BusinessAwayMessageScheduleOutsideWorkHours)(nil)
	_ IBusinessAwayMessageSchedule = (*BusinessAwayMessageScheduleCustom)(nil)
)
...
func (*BusinessAwayMessageScheduleAlways) _IBusinessAwayMessageSchedule() {}
...
func (*BusinessAwayMessageScheduleOutsideWorkHours) _IBusinessAwayMessageSchedule() {}
...
func (*BusinessAwayMessageScheduleCustom) _IBusinessAwayMessageSchedule() {}

type IBusinessBotRecipients interface {
	tl.Object
	_IBusinessBotRecipients()
}

var (
	_ IBusinessBotRecipients = (*BusinessBotRecipients)(nil)
)
...
func (*BusinessBotRecipients) _IBusinessBotRecipients() {}

type IBusinessChatLink interface {
	tl.Object
	_IBusinessChatLink()
}

var (
	_ IBusinessChatLink = (*BusinessChatLink)(nil)
)
...
func (*BusinessChatLink) _IBusinessChatLink() {}

type IBusinessGreetingMessage interface {
	tl.Object
	_IBusinessGreetingMessage()
}

var (
	_ IBusinessGreetingMessage = (*BusinessGreetingMessage)(nil)
)
...
func (*BusinessGreetingMessage) _IBusinessGreetingMessage() {}

type IBusinessIntro interface {
	tl.Object
	_IBusinessIntro()
}

var (
	_ IBusinessIntro = (*BusinessIntro)(nil)
)
...
type BusinessIntro struct {
	...
	Title       string
	Description string
	Sticker     IDocument `tl:",omitempty:flags:0"`
}

func (*BusinessIntro) CRC() uint32 {
	return 0x5a0a066d
}
func (*BusinessIntro) _IBusinessIntro() {}

type IBusinessLocation interface {
	tl.Object
	_IBusinessLocation()
}

var (
	_ IBusinessLocation = (*BusinessLocation)(nil)
)

type BusinessLocation struct {
	_        struct{}  `tl:"flags,bitflag"`
	GeoPoint IGeoPoint `tl:",omitempty:flags:0"`
	Address  string
}
...
func (*BusinessLocation) _IBusinessLocation() {}

type IBusinessRecipients interface {
	tl.Object
	_IBusinessRecipients()
}

var (
	_ IBusinessRecipients = (*BusinessRecipients)(nil)
)
...
func (*BusinessRecipients) _IBusinessRecipients() {}

type IBusinessWeeklyOpen interface {
	tl.Object
	_IBusinessWeeklyOpen()
}

var (
	_ IBusinessWeeklyOpen = (*BusinessWeeklyOpen)(nil)
)
...
func (*BusinessWeeklyOpen) _IBusinessWeeklyOpen() {}

type IBusinessWorkHours interface {
	tl.Object
	_IBusinessWorkHours()
}

var (
	_ IBusinessWorkHours = (*BusinessWorkHours)(nil)
)
...
type BusinessWorkHours struct {
	...
	TimezoneID string
	WeeklyOpen []IBusinessWeeklyOpen
}

func (*BusinessWorkHours) CRC() uint32 {
	return 0x8c92b098
}
func (*BusinessWorkHours) _IBusinessWorkHours() {}
...
var (
	...
	_ IChannelAdminLogEventAction = (*ChannelAdminLogEventActionChangeEmojiStickerSet)(nil)
)
...
func (*ChannelAdminLogEventActionChangeEmojiStickerSet) _IChannelAdminLogEventAction() {}
...
type Chat struct {
	...
	Date                int32
	Version             int32
	MigratedTo          IInputChannel     `tl:",omitempty:flags:6"`
	AdminRights         IChatAdminRights  `tl:",omitempty:flags:14"`
	DefaultBannedRights IChatBannedRights `tl:",omitempty:flags:18"`
}
...
type Channel struct {
	...
	Photo               IChatPhoto
	Date                int32
	RestrictionReason   []IRestrictionReason `tl:",omitempty:flags:9"`
	AdminRights         IChatAdminRights     `tl:",omitempty:flags:14"`
	BannedRights        IChatBannedRights    `tl:",omitempty:flags:15"`
	DefaultBannedRights IChatBannedRights    `tl:",omitempty:flags:18"`
...
type ChatFull struct {
	...
	ChatPhoto              IPhoto `tl:",omitempty:flags:2"`
	NotifySettings         IPeerNotifySettings
	ExportedInvite         IExportedChatInvite `tl:",omitempty:flags:13"`
...
type ChannelFull struct {
	...
	ChatPhoto              IPhoto
	NotifySettings         IPeerNotifySettings
	ExportedInvite         IExportedChatInvite `tl:",omitempty:flags:23"`
	BotInfo                []IBotInfo
	...
	Stickerset             IStickerSet      `tl:",omitempty:flags:8"`
	AvailableMinID         *int32           `tl:",omitempty:flags:9"`
	FolderID               *int32           `tl:",omitempty:flags:11"`
	LinkedChatID           *int64           `tl:",omitempty:flags:14"`
	Location               IChannelLocation `tl:",omitempty:flags:15"`
	...
	Emojiset               IStickerSet     `tl:",omitempty:flags2:10"`
}
...
type Config struct {
	...
	ReactionsDefault        IReaction `tl:",omitempty:flags:15"`
...
type IConnectedBot interface {
	tl.Object
	_IConnectedBot()
}

var (
	_ IConnectedBot = (*ConnectedBot)(nil)
)
...
func (*ConnectedBot) _IConnectedBot() {}
...
type IContactBirthday interface {
	tl.Object
	_IContactBirthday()
}

var (
	_ IContactBirthday = (*ContactBirthday)(nil)
)
...
func (*ContactBirthday) _IContactBirthday() {}
...
var (
	...
	_ IEmojiGroup = (*EmojiGroupGreeting)(nil)
	_ IEmojiGroup = (*EmojiGroupPremium)(nil)
)
...
func (*EmojiGroupGreeting) _IEmojiGroup() {}
...
func (*EmojiGroupPremium) _IEmojiGroup() {}
...
type IFactCheck interface {
	tl.Object
	_IFactCheck()
}

var (
	_ IFactCheck = (*FactCheck)(nil)
)
...
type IFoundStory interface {
	tl.Object
	_IFoundStory()
}

var (
	_ IFoundStory = (*FoundStory)(nil)
)
...
type IGeoPointAddress interface {
	tl.Object
	_IGeoPointAddress()
}

var (
	_ IGeoPointAddress = (*GeoPointAddress)(nil)
)
...
func (*GeoPointAddress) _IGeoPointAddress() {}
...
type IInputBusinessAwayMessage interface {
	tl.Object
	_IInputBusinessAwayMessage()
}

var (
	_ IInputBusinessAwayMessage = (*InputBusinessAwayMessage)(nil)
)
...
func (*InputBusinessAwayMessage) _IInputBusinessAwayMessage() {}

type IInputBusinessBotRecipients interface {
	tl.Object
	_IInputBusinessBotRecipients()
}

var (
	_ IInputBusinessBotRecipients = (*InputBusinessBotRecipients)(nil)
)
...
type InputBusinessBotRecipients struct {
	...
	NonContacts     bool         `tl:",omitempty:flags:3,implicit"`
	ExcludeSelected bool         `tl:",omitempty:flags:5,implicit"`
	Users           []IInputUser `tl:",omitempty:flags:4"`
	ExcludeUsers    []IInputUser `tl:",omitempty:flags:6"`
}

func (*InputBusinessBotRecipients) CRC() uint32 {
	return 0xc4e5921e
}
func (*InputBusinessBotRecipients) _IInputBusinessBotRecipients() {}

type IInputBusinessChatLink interface {
	tl.Object
	_IInputBusinessChatLink()
}

var (
	_ IInputBusinessChatLink = (*InputBusinessChatLink)(nil)
)
...
func (*InputBusinessChatLink) _IInputBusinessChatLink() {}

type IInputBusinessGreetingMessage interface {
	tl.Object
	_IInputBusinessGreetingMessage()
}

var (
	_ IInputBusinessGreetingMessage = (*InputBusinessGreetingMessage)(nil)
)
...
func (*InputBusinessGreetingMessage) _IInputBusinessGreetingMessage() {}

type IInputBusinessIntro interface {
	tl.Object
	_IInputBusinessIntro()
}

var (
	_ IInputBusinessIntro = (*InputBusinessIntro)(nil)
)
...
type InputBusinessIntro struct {
	...
	Title       string
	Description string
	Sticker     IInputDocument `tl:",omitempty:flags:0"`
}

func (*InputBusinessIntro) CRC() uint32 {
	return 0x9c469cd
}
func (*InputBusinessIntro) _IInputBusinessIntro() {}

type IInputBusinessRecipients interface {
	tl.Object
	_IInputBusinessRecipients()
}

var (
	_ IInputBusinessRecipients = (*InputBusinessRecipients)(nil)
)
...
func (*InputBusinessRecipients) _IInputBusinessRecipients() {}
...
type IInputCollectible interface {
	tl.Object
	_IInputCollectible()
}

var (
	_ IInputCollectible = (*InputCollectibleUsername)(nil)
	_ IInputCollectible = (*InputCollectiblePhone)(nil)
)
...
func (*InputCollectibleUsername) _IInputCollectible() {}
...
func (*InputCollectiblePhone) _IInputCollectible() {}
...
var (
	...
	_ IInputInvoice = (*InputInvoiceStars)(nil)
)
...
func (*InputInvoiceStars) _IInputInvoice() {}
...
var (
	...
	_ IInputMedia = (*InputMediaPaidMedia)(nil)
)
...
type InputMediaUploadedPhoto struct {
	...
	File       IInputFile
	Stickers   []IInputDocument `tl:",omitempty:flags:0"`
...
type InputMediaUploadedDocument struct {
	...
	File         IInputFile
	Thumb        IInputFile `tl:",omitempty:flags:2"`
	MimeType     string
	Attributes   []IDocumentAttribute
	Stickers     []IInputDocument `tl:",omitempty:flags:0"`
	TTLSeconds   *int32           `tl:",omitempty:flags:1"`
...
type InputMediaPoll struct {
	...
	SolutionEntities []IMessageEntity `tl:",omitempty:flags:1"`
}
...
type InputMediaPaidMedia struct {
	StarsAmount   int64
	ExtendedMedia []IInputMedia
}

func (*InputMediaPaidMedia) CRC() uint32 {
	return 0xaa661fc3
}
func (*InputMediaPaidMedia) _IInputMedia() {}
...
var (
	...
	_ IInputPrivacyRule = (*InputPrivacyValueAllowPremium)(nil)
)
...
func (*InputPrivacyValueAllowPremium) _IInputPrivacyRule() {}

type IInputQuickReplyShortcut interface {
	tl.Object
	_IInputQuickReplyShortcut()
}

var (
	_ IInputQuickReplyShortcut = (*InputQuickReplyShortcut)(nil)
	_ IInputQuickReplyShortcut = (*InputQuickReplyShortcutID)(nil)
)
...
func (*InputQuickReplyShortcut) CRC() uint32 {
	return 0x24596d41
}
func (*InputQuickReplyShortcut) _IInputQuickReplyShortcut() {}
...
func (*InputQuickReplyShortcutID) _IInputQuickReplyShortcut() {}
...
type IInputStarsTransaction interface {
	tl.Object
	_IInputStarsTransaction()
}

var (
	_ IInputStarsTransaction = (*InputStarsTransaction)(nil)
)
...
func (*InputStarsTransaction) _IInputStarsTransaction() {}
...
var (
	...
	_ IInputStorePaymentPurpose = (*InputStorePaymentStarsTopup)(nil)
	_ IInputStorePaymentPurpose = (*InputStorePaymentStarsGift)(nil)
)
...
func (*InputStorePaymentStarsTopup) _IInputStorePaymentPurpose() {}
...
func (*InputStorePaymentStarsGift) _IInputStorePaymentPurpose() {}
...
var (
	...
	_ IKeyboardButton = (*InputKeyboardButtonRequestPeer)(nil)
)
...
func (*InputKeyboardButtonRequestPeer) _IKeyboardButton() {}
...
var (
	...
	_ IMediaArea = (*MediaAreaURL)(nil)
	_ IMediaArea = (*MediaAreaWeather)(nil)
)
...
type MediaAreaGeoPoint struct {
	...
	Coordinates IMediaAreaCoordinates
	Geo         IGeoPoint
	Address     IGeoPointAddress `tl:",omitempty:flags:0"`
}
...
func (*MediaAreaWeather) _IMediaArea() {}
...
type Message struct {
	...
	ID                   int32
	FromID               IPeer  `tl:",omitempty:flags:8"`
	FromBoostsApplied    *int32 `tl:",omitempty:flags:29"`
	PeerID               IPeer
	SavedPeerID          IPeer               `tl:",omitempty:flags:28"`
...
var (
	...
	_ IMessageAction = (*MessageActionBoostApply)(nil)
	_ IMessageAction = (*MessageActionRequestedPeerSentMe)(nil)
	_ IMessageAction = (*MessageActionPaymentRefunded)(nil)
	_ IMessageAction = (*MessageActionGiftStars)(nil)
)
...
func (*MessageActionBoostApply) _IMessageAction() {}

type MessageActionRequestedPeerSentMe struct {
	ButtonID int32
	Peers    []IRequestedPeer
}

func (*MessageActionRequestedPeerSentMe) CRC() uint32 {
	return 0x93b31848
}
func (*MessageActionRequestedPeerSentMe) _IMessageAction() {}
...
func (*MessageActionPaymentRefunded) _IMessageAction() {}
...
func (*MessageActionGiftStars) _IMessageAction() {}
...
type MessageFwdHeader struct {
	...
	SavedFromID    IPeer   `tl:",omitempty:flags:8"`
...
var (
	...
	_ IMessageMedia = (*MessageMediaPaidMedia)(nil)
)
...
func (*MessageMediaPaidMedia) _IMessageMedia() {}
...
type IMissingInvitee interface {
	tl.Object
	_IMissingInvitee()
}

var (
	_ IMissingInvitee = (*MissingInvitee)(nil)
)
...
func (*MissingInvitee) _IMissingInvitee() {}
...
type IOutboxReadDate interface {
	tl.Object
	_IOutboxReadDate()
}

var (
	_ IOutboxReadDate = (*OutboxReadDate)(nil)
)
...
func (*OutboxReadDate) _IOutboxReadDate() {}
...
type PhoneCall struct {
	...
	StartDate        int32
	CustomParameters IDataJSON `tl:",omitempty:flags:7"`
}
...
var (
	...
	_ IPrivacyRule = (*PrivacyValueAllowPremium)(nil)
)
...
func (*PrivacyValueAllowPremium) _IPrivacyRule() {}
...
type IQuickReply interface {
	tl.Object
	_IQuickReply()
}

var (
	_ IQuickReply = (*QuickReply)(nil)
)
...
type IReactionsNotifySettings interface {
	tl.Object
	_IReactionsNotifySettings()
}

var (
	_ IReactionsNotifySettings = (*ReactionsNotifySettings)(nil)
)

type ReactionsNotifySettings struct {
	_                  struct{}                      `tl:"flags,bitflag"`
	MessagesNotifyFrom EnumReactionNotificationsFrom `tl:",omitempty:flags:0"`
	StoriesNotifyFrom  EnumReactionNotificationsFrom `tl:",omitempty:flags:1"`
...
func (*ReactionsNotifySettings) _IReactionsNotifySettings() {}
...
type IRequestedPeer interface {
	tl.Object
	_IRequestedPeer()
}

var (
	_ IRequestedPeer = (*RequestedPeerUser)(nil)
	_ IRequestedPeer = (*RequestedPeerChat)(nil)
	_ IRequestedPeer = (*RequestedPeerChannel)(nil)
)
...
type RequestedPeerUser struct {
	...
	Photo     IPhoto  `tl:",omitempty:flags:2"`
}

func (*RequestedPeerUser) CRC() uint32 {
	return 0xd62ff46a
}
func (*RequestedPeerUser) _IRequestedPeer() {}
...
func (*RequestedPeerChat) _IRequestedPeer() {}
...
func (*RequestedPeerChannel) _IRequestedPeer() {}
...
type ISavedDialog interface {
	tl.Object
	_ISavedDialog()
}

var (
	_ ISavedDialog = (*SavedDialog)(nil)
)
...
func (*SavedDialog) _ISavedDialog() {}

type ISavedReactionTag interface {
	tl.Object
	_ISavedReactionTag()
}

var (
	_ ISavedReactionTag = (*SavedReactionTag)(nil)
)
...
func (*SavedReactionTag) _ISavedReactionTag() {}
...
type ISmsJob interface {
	tl.Object
	_ISmsJob()
}

var (
	_ ISmsJob = (*SmsJob)(nil)
)
...
type SponsoredMessage struct {
	...
	Message        string
	Entities       []IMessageEntity `tl:",omitempty:flags:1"`
	Photo          IPhoto           `tl:",omitempty:flags:6"`
	Color          IPeerColor       `tl:",omitempty:flags:13"`
	ButtonText     string
...
type ISponsoredMessageReportOption interface {
	tl.Object
	_ISponsoredMessageReportOption()
}

var (
	_ ISponsoredMessageReportOption = (*SponsoredMessageReportOption)(nil)
)
...
func (*SponsoredMessageReportOption) _ISponsoredMessageReportOption() {}

type IStarsGiftOption interface {
	tl.Object
	_IStarsGiftOption()
}

var (
	_ IStarsGiftOption = (*StarsGiftOption)(nil)
)
...
func (*StarsGiftOption) _IStarsGiftOption() {}

type IStarsRevenueStatus interface {
	tl.Object
	_IStarsRevenueStatus()
}

var (
	_ IStarsRevenueStatus = (*StarsRevenueStatus)(nil)
)
...
func (*StarsRevenueStatus) _IStarsRevenueStatus() {}

type IStarsTopupOption interface {
	tl.Object
	_IStarsTopupOption()
}

var (
	_ IStarsTopupOption = (*StarsTopupOption)(nil)
)
...
func (*StarsTopupOption) _IStarsTopupOption() {}

type IStarsTransaction interface {
	tl.Object
	_IStarsTransaction()
}

var (
	_ IStarsTransaction = (*StarsTransaction)(nil)
)
...
type StarsTransaction struct {
	...
	ExtendedMedia   []IMessageMedia `tl:",omitempty:flags:9"`
}

func (*StarsTransaction) CRC() uint32 {
	return 0x2db5418f
}
func (*StarsTransaction) _IStarsTransaction() {}

type IStarsTransactionPeer interface {
	tl.Object
	_IStarsTransactionPeer()
}

var (
	_ IStarsTransactionPeer = (*StarsTransactionPeerUnsupported)(nil)
	_ IStarsTransactionPeer = (*StarsTransactionPeerAppStore)(nil)
	_ IStarsTransactionPeer = (*StarsTransactionPeerPlayMarket)(nil)
	_ IStarsTransactionPeer = (*StarsTransactionPeerPremiumBot)(nil)
	_ IStarsTransactionPeer = (*StarsTransactionPeerFragment)(nil)
	_ IStarsTransactionPeer = (*StarsTransactionPeer)(nil)
	_ IStarsTransactionPeer = (*StarsTransactionPeerAds)(nil)
)
...
func (*StarsTransactionPeerUnsupported) _IStarsTransactionPeer() {}
...
func (*StarsTransactionPeerAppStore) _IStarsTransactionPeer() {}
...
func (*StarsTransactionPeerPlayMarket) _IStarsTransactionPeer() {}
...
func (*StarsTransactionPeerPremiumBot) _IStarsTransactionPeer() {}
...
func (*StarsTransactionPeerFragment) _IStarsTransactionPeer() {}

type StarsTransactionPeer struct {
	Peer IPeer
}

func (*StarsTransactionPeer) CRC() uint32 {
	return 0xd80da15d
}
func (*StarsTransactionPeer) _IStarsTransactionPeer() {}
...
func (*StarsTransactionPeerAds) _IStarsTransactionPeer() {}
...
type StoryItem struct {
	...
	ID               int32
	Date             int32
	FromID           IPeer           `tl:",omitempty:flags:18"`
...
var (
	...
	_ IUpdate = (*UpdateSavedDialogPinned)(nil)
	_ IUpdate = (*UpdatePinnedSavedDialogs)(nil)
	_ IUpdate = (*UpdateSavedReactionTags)(nil)
	_ IUpdate = (*UpdateSmsJob)(nil)
	_ IUpdate = (*UpdateQuickReplies)(nil)
	_ IUpdate = (*UpdateNewQuickReply)(nil)
	_ IUpdate = (*UpdateDeleteQuickReply)(nil)
	_ IUpdate = (*UpdateQuickReplyMessage)(nil)
	_ IUpdate = (*UpdateDeleteQuickReplyMessages)(nil)
	_ IUpdate = (*UpdateBotBusinessConnect)(nil)
	_ IUpdate = (*UpdateBotNewBusinessMessage)(nil)
	_ IUpdate = (*UpdateBotEditBusinessMessage)(nil)
	_ IUpdate = (*UpdateBotDeleteBusinessMessage)(nil)
	_ IUpdate = (*UpdateNewStoryReaction)(nil)
	_ IUpdate = (*UpdateBroadcastRevenueTransactions)(nil)
	_ IUpdate = (*UpdateStarsBalance)(nil)
	_ IUpdate = (*UpdateBusinessBotCallbackQuery)(nil)
	_ IUpdate = (*UpdateStarsRevenueStatus)(nil)
)
...
type UpdateChannelParticipant struct {
	...
	ActorID         int64
	UserID          int64
	PrevParticipant IChannelParticipant `tl:",omitempty:flags:0"`
	NewParticipant  IChannelParticipant `tl:",omitempty:flags:1"`
	Invite          IExportedChatInvite `tl:",omitempty:flags:2"`
	Qts             int32
}
...
func (*UpdateSavedDialogPinned) _IUpdate() {}
...
func (*UpdatePinnedSavedDialogs) _IUpdate() {}
...
func (*UpdateSavedReactionTags) _IUpdate() {}
...
func (*UpdateQuickReplies) _IUpdate() {}
...
func (*UpdateNewQuickReply) _IUpdate() {}
...
func (*UpdateDeleteQuickReply) _IUpdate() {}
...
func (*UpdateQuickReplyMessage) _IUpdate() {}
...
func (*UpdateDeleteQuickReplyMessages) _IUpdate() {}
...
func (*UpdateBotBusinessConnect) _IUpdate() {}

type UpdateBotNewBusinessMessage struct {
	_              struct{} `tl:"flags,bitflag"`
	ConnectionID   string
	Message        IMessage
	ReplyToMessage IMessage `tl:",omitempty:flags:0"`
	Qts            int32
}
...
func (*UpdateBotNewBusinessMessage) _IUpdate() {}
...
func (*UpdateBotEditBusinessMessage) _IUpdate() {}
...
func (*UpdateBotDeleteBusinessMessage) _IUpdate() {}
...
func (*UpdateNewStoryReaction) _IUpdate() {}
...
func (*UpdateBroadcastRevenueTransactions) _IUpdate() {}
...
func (*UpdateStarsBalance) _IUpdate() {}
...
type UpdateBusinessBotCallbackQuery struct {
	...
	ConnectionID   string
	Message        IMessage
	ReplyToMessage IMessage `tl:",omitempty:flags:2"`
	ChatInstance   int64
	Data           *[]byte `tl:",omitempty:flags:0"`
}
...
func (*UpdateBusinessBotCallbackQuery) _IUpdate() {}
...
func (*UpdateStarsRevenueStatus) _IUpdate() {}
...
type User struct {
	...
	Photo                 IUserProfilePhoto    `tl:",omitempty:flags:5"`
	Status                IUserStatus          `tl:",omitempty:flags:6"`
	BotInfoVersion        *int32               `tl:",omitempty:flags:14"`
	RestrictionReason     []IRestrictionReason `tl:",omitempty:flags:18"`
...
type UserFull struct {
	...
	BusinessWorkHours       IBusinessWorkHours       `tl:",omitempty:flags2:0"`
	BusinessLocation        IBusinessLocation        `tl:",omitempty:flags2:1"`
	BusinessGreetingMessage IBusinessGreetingMessage `tl:",omitempty:flags2:2"`
	BusinessAwayMessage     IBusinessAwayMessage     `tl:",omitempty:flags2:3"`
	BusinessIntro           IBusinessIntro           `tl:",omitempty:flags2:4"`
	Birthday                IBirthday                `tl:",omitempty:flags2:5"`
...
type WebPage struct {
	...
	Title         *string             `tl:",omitempty:flags:2"`
	Description   *string             `tl:",omitempty:flags:3"`
	Photo         IPhoto              `tl:",omitempty:flags:4"`
	...
	Document      IDocument           `tl:",omitempty:flags:9"`
	CachedPage    IPage               `tl:",omitempty:flags:10"`
	Attributes    []IWebPageAttribute `tl:",omitempty:flags:12"`
}
...
var (
	...
	_ IWebPageAttribute = (*WebPageAttributeStickerSet)(nil)
)
...
func (*WebPageAttributeStickerSet) _IWebPageAttribute() {}
...
type AccountAuthorizationForm struct {
	_                struct{} `tl:"flags,bitflag"`
	RequiredTypes    []ISecureRequiredType
	Values           []ISecureValue
...
type IAccountBusinessChatLinks interface {
	tl.Object
	_IAccountBusinessChatLinks()
}

var (
	_ IAccountBusinessChatLinks = (*AccountBusinessChatLinks)(nil)
)

type AccountBusinessChatLinks struct {
	Links []IBusinessChatLink
	Chats []IChat
	Users []IUser
}
...
func (*AccountBusinessChatLinks) _IAccountBusinessChatLinks() {}

type IAccountConnectedBots interface {
	tl.Object
	_IAccountConnectedBots()
}

var (
	_ IAccountConnectedBots = (*AccountConnectedBots)(nil)
)
...
func (*AccountConnectedBots) _IAccountConnectedBots() {}
...
type IAccountResolvedBusinessChatLinks interface {
	tl.Object
	_IAccountResolvedBusinessChatLinks()
}

var (
	_ IAccountResolvedBusinessChatLinks = (*AccountResolvedBusinessChatLinks)(nil)
)
...
func (*AccountResolvedBusinessChatLinks) _IAccountResolvedBusinessChatLinks() {}
...
var (
	...
	_ IAuthSentCodeType = (*AuthSentCodeTypeSmsWord)(nil)
	_ IAuthSentCodeType = (*AuthSentCodeTypeSmsPhrase)(nil)
)
...
func (*AuthSentCodeTypeSmsWord) _IAuthSentCodeType() {}
...
func (*AuthSentCodeTypeSmsPhrase) _IAuthSentCodeType() {}
...
type IBotsPopularAppBots interface {
	tl.Object
	_IBotsPopularAppBots()
}

var (
	_ IBotsPopularAppBots = (*BotsPopularAppBots)(nil)
)
...
func (*BotsPopularAppBots) _IBotsPopularAppBots() {}

type IBotsPreviewInfo interface {
	tl.Object
	_IBotsPreviewInfo()
}

var (
	_ IBotsPreviewInfo = (*BotsPreviewInfo)(nil)
)

type BotsPreviewInfo struct {
	Media     []IBotPreviewMedia
	LangCodes []string
}
...
func (*BotsPreviewInfo) _IBotsPreviewInfo() {}
...
type IChannelsSponsoredMessageReportResult interface {
	tl.Object
	_IChannelsSponsoredMessageReportResult()
}

var (
	_ IChannelsSponsoredMessageReportResult = (*ChannelsSponsoredMessageReportResultChooseOption)(nil)
	_ IChannelsSponsoredMessageReportResult = (*ChannelsSponsoredMessageReportResultAdsHidden)(nil)
	_ IChannelsSponsoredMessageReportResult = (*ChannelsSponsoredMessageReportResultReported)(nil)
)

type ChannelsSponsoredMessageReportResultChooseOption struct {
	Title   string
	Options []ISponsoredMessageReportOption
}

func (*ChannelsSponsoredMessageReportResultChooseOption) CRC() uint32 {
	return 0x846f9e42
}
func (*ChannelsSponsoredMessageReportResultChooseOption) _IChannelsSponsoredMessageReportResult() {}
...
func (*ChannelsSponsoredMessageReportResultAdsHidden) _IChannelsSponsoredMessageReportResult() {}
...
func (*ChannelsSponsoredMessageReportResultReported) _IChannelsSponsoredMessageReportResult() {}
...
type IContactsContactBirthdays interface {
	tl.Object
	_IContactsContactBirthdays()
}

var (
	_ IContactsContactBirthdays = (*ContactsContactBirthdays)(nil)
)

type ContactsContactBirthdays struct {
	Contacts []IContactBirthday
	Users    []IUser
}
...
func (*ContactsContactBirthdays) _IContactsContactBirthdays() {}
...
type IFragmentCollectibleInfo interface {
	tl.Object
	_IFragmentCollectibleInfo()
}

var (
	_ IFragmentCollectibleInfo = (*FragmentCollectibleInfo)(nil)
)
...
func (*FragmentCollectibleInfo) _IFragmentCollectibleInfo() {}
...
type IHelpTimezonesList interface {
	tl.Object
	_IHelpTimezonesList()
}

var (
	_ IHelpTimezonesList = (*HelpTimezonesListNotModified)(nil)
	_ IHelpTimezonesList = (*HelpTimezonesList)(nil)
)
...
func (*HelpTimezonesListNotModified) _IHelpTimezonesList() {}
...
func (*HelpTimezonesList) CRC() uint32 {
	return 0x7b74ed71
}
func (*HelpTimezonesList) _IHelpTimezonesList() {}
...
type IMessagesAvailableEffects interface {
	tl.Object
	_IMessagesAvailableEffects()
}

var (
	_ IMessagesAvailableEffects = (*MessagesAvailableEffectsNotModified)(nil)
	_ IMessagesAvailableEffects = (*MessagesAvailableEffects)(nil)
)
...
func (*MessagesAvailableEffectsNotModified) _IMessagesAvailableEffects() {}

type MessagesAvailableEffects struct {
	Hash      int32
	Effects   []IAvailableEffect
	Documents []IDocument
}

func (*MessagesAvailableEffects) CRC() uint32 {
	return 0xbddb616e
}
func (*MessagesAvailableEffects) _IMessagesAvailableEffects() {}
...
type IMessagesDialogFilters interface {
	tl.Object
	_IMessagesDialogFilters()
}

var (
	_ IMessagesDialogFilters = (*MessagesDialogFilters)(nil)
)
...
func (*MessagesDialogFilters) _IMessagesDialogFilters() {}
...
type IMessagesInvitedUsers interface {
	tl.Object
	_IMessagesInvitedUsers()
}

var (
	_ IMessagesInvitedUsers = (*MessagesInvitedUsers)(nil)
)

type MessagesInvitedUsers struct {
	Updates         IUpdates
	MissingInvitees []IMissingInvitee
}

func (*MessagesInvitedUsers) CRC() uint32 {
	return 0x7f5defa6
}
func (*MessagesInvitedUsers) _IMessagesInvitedUsers() {}
...
type IMessagesMyStickers interface {
	tl.Object
	_IMessagesMyStickers()
}

var (
	_ IMessagesMyStickers = (*MessagesMyStickers)(nil)
)
...
func (*MessagesMyStickers) _IMessagesMyStickers() {}
...
type IMessagesQuickReplies interface {
	tl.Object
	_IMessagesQuickReplies()
}

var (
	_ IMessagesQuickReplies = (*MessagesQuickReplies)(nil)
	_ IMessagesQuickReplies = (*MessagesQuickRepliesNotModified)(nil)
)
...
func (*MessagesQuickReplies) CRC() uint32 {
	return 0xc68d6695
}
func (*MessagesQuickReplies) _IMessagesQuickReplies() {}
...
func (*MessagesQuickRepliesNotModified) _IMessagesQuickReplies() {}
...
type IMessagesSavedDialogs interface {
	tl.Object
	_IMessagesSavedDialogs()
}

var (
	_ IMessagesSavedDialogs = (*MessagesSavedDialogs)(nil)
	_ IMessagesSavedDialogs = (*MessagesSavedDialogsSlice)(nil)
	_ IMessagesSavedDialogs = (*MessagesSavedDialogsNotModified)(nil)
)

type MessagesSavedDialogs struct {
	Dialogs  []ISavedDialog
	Messages []IMessage
	Chats    []IChat
	Users    []IUser
}

func (*MessagesSavedDialogs) CRC() uint32 {
	return 0xf83ae221
}
func (*MessagesSavedDialogs) _IMessagesSavedDialogs() {}
...
func (*MessagesSavedDialogsSlice) _IMessagesSavedDialogs() {}
...
func (*MessagesSavedDialogsNotModified) _IMessagesSavedDialogs() {}
...
type IMessagesSavedReactionTags interface {
	tl.Object
	_IMessagesSavedReactionTags()
}

var (
	_ IMessagesSavedReactionTags = (*MessagesSavedReactionTagsNotModified)(nil)
	_ IMessagesSavedReactionTags = (*MessagesSavedReactionTags)(nil)
)
...
func (*MessagesSavedReactionTagsNotModified) _IMessagesSavedReactionTags() {}

type MessagesSavedReactionTags struct {
	Tags []ISavedReactionTag
	Hash int64
}

func (*MessagesSavedReactionTags) CRC() uint32 {
	return 0x3259950a
}
func (*MessagesSavedReactionTags) _IMessagesSavedReactionTags() {}
...
var (
	...
	_ IPaymentsPaymentForm = (*PaymentsPaymentFormStars)(nil)
)
...
func (*PaymentsPaymentFormStars) _IPaymentsPaymentForm() {}
...
var (
	...
	_ IPaymentsPaymentReceipt = (*PaymentsPaymentReceiptStars)(nil)
)
...
func (*PaymentsPaymentReceiptStars) _IPaymentsPaymentReceipt() {}
...
type IPaymentsStarsRevenueAdsAccountURL interface {
	tl.Object
	_IPaymentsStarsRevenueAdsAccountURL()
}

var (
	_ IPaymentsStarsRevenueAdsAccountURL = (*PaymentsStarsRevenueAdsAccountURL)(nil)
)
...
func (*PaymentsStarsRevenueAdsAccountURL) _IPaymentsStarsRevenueAdsAccountURL() {}

type IPaymentsStarsRevenueStats interface {
	tl.Object
	_IPaymentsStarsRevenueStats()
}

var (
	_ IPaymentsStarsRevenueStats = (*PaymentsStarsRevenueStats)(nil)
)

type PaymentsStarsRevenueStats struct {
	RevenueGraph IStatsGraph
	Status       IStarsRevenueStatus
	UsdRate      float64
}
...
func (*PaymentsStarsRevenueStats) _IPaymentsStarsRevenueStats() {}

type IPaymentsStarsRevenueWithdrawalURL interface {
	tl.Object
	_IPaymentsStarsRevenueWithdrawalURL()
}

var (
	_ IPaymentsStarsRevenueWithdrawalURL = (*PaymentsStarsRevenueWithdrawalURL)(nil)
)
...
func (*PaymentsStarsRevenueWithdrawalURL) _IPaymentsStarsRevenueWithdrawalURL() {}

type IPaymentsStarsStatus interface {
	tl.Object
	_IPaymentsStarsStatus()
}

var (
	_ IPaymentsStarsStatus = (*PaymentsStarsStatus)(nil)
)

type PaymentsStarsStatus struct {
	_          struct{} `tl:"flags,bitflag"`
	Balance    int64
	History    []IStarsTransaction
	NextOffset *string `tl:",omitempty:flags:0"`
	Chats      []IChat
	Users      []IUser
}
...
func (*PaymentsStarsStatus) _IPaymentsStarsStatus() {}
...
type ISmsjobsEligibilityToJoin interface {
	tl.Object
	_ISmsjobsEligibilityToJoin()
}

var (
	_ ISmsjobsEligibilityToJoin = (*SmsjobsEligibleToJoin)(nil)
)
...
func (*SmsjobsEligibleToJoin) _ISmsjobsEligibilityToJoin() {}

type ISmsjobsStatus interface {
	tl.Object
	_ISmsjobsStatus()
}

var (
	_ ISmsjobsStatus = (*SmsjobsStatus)(nil)
)
...
func (*SmsjobsStatus) _ISmsjobsStatus() {}

type IStatsBroadcastRevenueStats interface {
	tl.Object
	_IStatsBroadcastRevenueStats()
}

var (
	_ IStatsBroadcastRevenueStats = (*StatsBroadcastRevenueStats)(nil)
)
...
func (*StatsBroadcastRevenueStats) _IStatsBroadcastRevenueStats() {}

type IStatsBroadcastRevenueTransactions interface {
	tl.Object
	_IStatsBroadcastRevenueTransactions()
}

var (
	_ IStatsBroadcastRevenueTransactions = (*StatsBroadcastRevenueTransactions)(nil)
)

type StatsBroadcastRevenueTransactions struct {
	Count        int32
	Transactions []IBroadcastRevenueTransaction
}

func (*StatsBroadcastRevenueTransactions) CRC() uint32 {
	return 0x87158466
}
func (*StatsBroadcastRevenueTransactions) _IStatsBroadcastRevenueTransactions() {}

type IStatsBroadcastRevenueWithdrawalURL interface {
	tl.Object
	_IStatsBroadcastRevenueWithdrawalURL()
}

var (
	_ IStatsBroadcastRevenueWithdrawalURL = (*StatsBroadcastRevenueWithdrawalURL)(nil)
)
...
func (*StatsBroadcastRevenueWithdrawalURL) _IStatsBroadcastRevenueWithdrawalURL() {}
...
type StatsBroadcastStats struct {
	...
	ViewsPerPost                 IStatsAbsValueAndPrev
	SharesPerPost                IStatsAbsValueAndPrev
	...
	EnabledNotifications         IStatsPercentValue
	GrowthGraph                  IStatsGraph
	FollowersGraph               IStatsGraph
	MuteGraph                    IStatsGraph
	TopHoursGraph                IStatsGraph
	InteractionsGraph            IStatsGraph
	IvInteractionsGraph          IStatsGraph
	ViewsBySourceGraph           IStatsGraph
	NewFollowersBySourceGraph    IStatsGraph
	...
	RecentPostsInteractions      []IPostInteractionCounters
}
...
type IStoriesFoundStories interface {
	tl.Object
	_IStoriesFoundStories()
}

var (
	_ IStoriesFoundStories = (*StoriesFoundStories)(nil)
)
...
func (*StoriesFoundStories) _IStoriesFoundStories() {}
...
const (
	BaseThemeClassic EnumBaseTheme = 0xc3a12462
	BaseThemeDay     EnumBaseTheme = 0xfbd81688
	BaseThemeNight   EnumBaseTheme = 0xb7b31ea8
	BaseThemeTinted  EnumBaseTheme = 0x6d5f77ee
	BaseThemeArctic  EnumBaseTheme = 0x5b11125a
)

type EnumBool uint32

const (
	BoolFalse EnumBool = 0xbc799737
	BoolTrue  EnumBool = 0x997275b5
)
...
const (
	InputPrivacyKeyStatusTimestamp EnumInputPrivacyKey = 0x4f96cb18
	InputPrivacyKeyChatInvite      EnumInputPrivacyKey = 0xbdfb0426
	InputPrivacyKeyPhoneCall       EnumInputPrivacyKey = 0xfabadc5f
	InputPrivacyKeyPhoneP2P        EnumInputPrivacyKey = 0xdb9e70d2
	InputPrivacyKeyForwards        EnumInputPrivacyKey = 0xa4dd4c08
	InputPrivacyKeyProfilePhoto    EnumInputPrivacyKey = 0x5719bacc
	InputPrivacyKeyPhoneNumber     EnumInputPrivacyKey = 0x352dafa
	InputPrivacyKeyAddedByPhone    EnumInputPrivacyKey = 0xd1219bdd
	InputPrivacyKeyVoiceMessages   EnumInputPrivacyKey = 0xaee69d68
	InputPrivacyKeyAbout           EnumInputPrivacyKey = 0x3823cc40
	InputPrivacyKeyBirthday        EnumInputPrivacyKey = 0xd65a11cc
)

type EnumNull uint32

const (
	Null EnumNull = 0x56730bcc
)

type EnumPhoneCallDiscardReason uint32

const (
	PhoneCallDiscardReasonMissed     EnumPhoneCallDiscardReason = 0x85e42301
	PhoneCallDiscardReasonDisconnect EnumPhoneCallDiscardReason = 0xe095c1a0
	PhoneCallDiscardReasonHangup     EnumPhoneCallDiscardReason = 0x57adc690
	PhoneCallDiscardReasonBusy       EnumPhoneCallDiscardReason = 0xfaf7e8c9
)

type EnumPrivacyKey uint32

const (
	PrivacyKeyStatusTimestamp EnumPrivacyKey = 0xbc2eab30
	PrivacyKeyChatInvite      EnumPrivacyKey = 0x500e6dfa
	PrivacyKeyPhoneCall       EnumPrivacyKey = 0x3d662b7b
	PrivacyKeyPhoneP2P        EnumPrivacyKey = 0x39491cc8
	PrivacyKeyForwards        EnumPrivacyKey = 0x69ec56a3
	PrivacyKeyProfilePhoto    EnumPrivacyKey = 0x96151fed
	PrivacyKeyPhoneNumber     EnumPrivacyKey = 0xd19ae46d
	PrivacyKeyAddedByPhone    EnumPrivacyKey = 0x42ffd42b
	PrivacyKeyVoiceMessages   EnumPrivacyKey = 0x697f414
	PrivacyKeyAbout           EnumPrivacyKey = 0xa486b761
	PrivacyKeyBirthday        EnumPrivacyKey = 0x2000a518
)

type EnumReactionNotificationsFrom uint32

const (
	ReactionNotificationsFromContacts EnumReactionNotificationsFrom = 0xbac3a61a
	ReactionNotificationsFromAll      EnumReactionNotificationsFrom = 0x4b9e22a0
)
...
const (
	SecureValueTypePersonalDetails       EnumSecureValueType = 0x9d2a81e3
	SecureValueTypePassport              EnumSecureValueType = 0x3dac6a00
	SecureValueTypeDriverLicense         EnumSecureValueType = 0x6e425c4
	SecureValueTypeIdentityCard          EnumSecureValueType = 0xa0d0744b
	SecureValueTypeInternalPassport      EnumSecureValueType = 0x99a48f23
	SecureValueTypeAddress               EnumSecureValueType = 0xcbe31e26
	SecureValueTypeUtilityBill           EnumSecureValueType = 0xfc36954e
	SecureValueTypeBankStatement         EnumSecureValueType = 0x89137c0d
	SecureValueTypeRentalAgreement       EnumSecureValueType = 0x8b883488
	SecureValueTypePassportRegistration  EnumSecureValueType = 0x99e3806a
	SecureValueTypeTemporaryRegistration EnumSecureValueType = 0xea02ec33
	SecureValueTypePhone                 EnumSecureValueType = 0xb320aadb
	SecureValueTypeEmail                 EnumSecureValueType = 0x8e3ca7ee
)

type EnumTopPeerCategory uint32

const (
	TopPeerCategoryBotsPm         EnumTopPeerCategory = 0xab661b5b
	TopPeerCategoryBotsInline     EnumTopPeerCategory = 0x148677e2
	TopPeerCategoryCorrespondents EnumTopPeerCategory = 0x637b7ed
	TopPeerCategoryGroups         EnumTopPeerCategory = 0xbd17a14a
	TopPeerCategoryChannels       EnumTopPeerCategory = 0x161d9628
	TopPeerCategoryPhoneCalls     EnumTopPeerCategory = 0x1e76a78c
	TopPeerCategoryForwardUsers   EnumTopPeerCategory = 0xa8406ca9
	TopPeerCategoryForwardChats   EnumTopPeerCategory = 0xfbeec0f0
	TopPeerCategoryBotsApp        EnumTopPeerCategory = 0xfd9e7bec
)

type EnumTrue uint32

const (
	True EnumTrue = 0x3fedd339
)

type EnumAuthCodeType uint32

const (
	AuthCodeTypeSms         EnumAuthCodeType = 0x72a3158c
	AuthCodeTypeCall        EnumAuthCodeType = 0x741cd3e3
	AuthCodeTypeFlashCall   EnumAuthCodeType = 0x226ccefb
...
const (
	StorageFileUnknown EnumStorageFileType = 0xaa963b05
	StorageFilePartial EnumStorageFileType = 0x40bc6f52
	StorageFileJpeg    EnumStorageFileType = 0x7efe0e
	StorageFileGif     EnumStorageFileType = 0xcae1aadf
	StorageFilePng     EnumStorageFileType = 0xa4f63c0
	StorageFilePdf     EnumStorageFileType = 0xae1e508d
	StorageFileMp3     EnumStorageFileType = 0x528a0677
	StorageFileMov     EnumStorageFileType = 0x4b09ebbc
	StorageFileMp4     EnumStorageFileType = 0xb3cea0e4
	StorageFileWebp    EnumStorageFileType = 0x1081464c
)
...
type AccountUpdateBusinessWorkHoursRequest struct {
	_                 struct{}           `tl:"flags,bitflag"`
	BusinessWorkHours IBusinessWorkHours `tl:",omitempty:flags:0"`
}
...
type AccountUpdateBusinessLocationRequest struct {
	_        struct{}       `tl:"flags,bitflag"`
	GeoPoint IInputGeoPoint `tl:",omitempty:flags:1"`
...
type AccountUpdateBusinessGreetingMessageRequest struct {
	_       struct{}                      `tl:"flags,bitflag"`
	Message IInputBusinessGreetingMessage `tl:",omitempty:flags:0"`
}
...
type AccountUpdateBusinessAwayMessageRequest struct {
	_       struct{}                  `tl:"flags,bitflag"`
	Message IInputBusinessAwayMessage `tl:",omitempty:flags:0"`
}
...
func AccountUpdateConnectedBot(ctx context.Context, m Requester, i AccountUpdateConnectedBotRequest) (IUpdates, error) {
	var res IUpdates
	return res, request(ctx, m, &i, &res)
}
...
func AccountGetConnectedBots(ctx context.Context, m Requester, i AccountGetConnectedBotsRequest) (IAccountConnectedBots, error) {
	var res IAccountConnectedBots
	return res, request(ctx, m, &i, &res)
}
...
func AccountGetBotBusinessConnection(ctx context.Context, m Requester, i AccountGetBotBusinessConnectionRequest) (IUpdates, error) {
	var res IUpdates
	return res, request(ctx, m, &i, &res)
}
...
type AccountUpdateBusinessIntroRequest struct {
	_     struct{}            `tl:"flags,bitflag"`
	Intro IInputBusinessIntro `tl:",omitempty:flags:0"`
}
...
type AccountUpdateBirthdayRequest struct {
	_        struct{}  `tl:"flags,bitflag"`
	Birthday IBirthday `tl:",omitempty:flags:0"`
}
...
func AccountCreateBusinessChatLink(ctx context.Context, m Requester, i AccountCreateBusinessChatLinkRequest) (IBusinessChatLink, error) {
	var res IBusinessChatLink
	return res, request(ctx, m, &i, &res)
}
...
func AccountEditBusinessChatLink(ctx context.Context, m Requester, i AccountEditBusinessChatLinkRequest) (IBusinessChatLink, error) {
	var res IBusinessChatLink
	return res, request(ctx, m, &i, &res)
}
...
func AccountGetBusinessChatLinks(ctx context.Context, m Requester, i AccountGetBusinessChatLinksRequest) (IAccountBusinessChatLinks, error) {
	var res IAccountBusinessChatLinks
	return res, request(ctx, m, &i, &res)
}
...
func AccountResolveBusinessChatLink(ctx context.Context, m Requester, i AccountResolveBusinessChatLinkRequest) (IAccountResolvedBusinessChatLinks, error) {
	var res IAccountResolvedBusinessChatLinks
	return res, request(ctx, m, &i, &res)
}
...
func AccountGetReactionsNotifySettings(ctx context.Context, m Requester, i AccountGetReactionsNotifySettingsRequest) (IReactionsNotifySettings, error) {
	var res IReactionsNotifySettings
	return res, request(ctx, m, &i, &res)
}
...
func AccountSetReactionsNotifySettings(ctx context.Context, m Requester, i AccountSetReactionsNotifySettingsRequest) (IReactionsNotifySettings, error) {
	var res IReactionsNotifySettings
	return res, request(ctx, m, &i, &res)
}
...
func BotsGetPopularAppBots(ctx context.Context, m Requester, i BotsGetPopularAppBotsRequest) (IBotsPopularAppBots, error) {
	var res IBotsPopularAppBots
	return res, request(ctx, m, &i, &res)
}
...
func BotsAddPreviewMedia(ctx context.Context, m Requester, i BotsAddPreviewMediaRequest) (IBotPreviewMedia, error) {
	var res IBotPreviewMedia
	return res, request(ctx, m, &i, &res)
}
...
func BotsEditPreviewMedia(ctx context.Context, m Requester, i BotsEditPreviewMediaRequest) (IBotPreviewMedia, error) {
	var res IBotPreviewMedia
	return res, request(ctx, m, &i, &res)
}
...
func BotsGetPreviewInfo(ctx context.Context, m Requester, i BotsGetPreviewInfoRequest) (IBotsPreviewInfo, error) {
	var res IBotsPreviewInfo
	return res, request(ctx, m, &i, &res)
}
...
func BotsGetPreviewMedias(ctx context.Context, m Requester, i BotsGetPreviewMediasRequest) ([]IBotPreviewMedia, error) {
	var res []IBotPreviewMedia
	return res, request(ctx, m, &i, &res)
}
...
func ChannelsInviteToChannel(ctx context.Context, m Requester, i ChannelsInviteToChannelRequest) (IMessagesInvitedUsers, error) {
	var res IMessagesInvitedUsers
	return res, request(ctx, m, &i, &res)
}
...
type ChannelsGetChannelRecommendationsRequest struct {
	_       struct{}      `tl:"flags,bitflag"`
	Channel IInputChannel `tl:",omitempty:flags:0"`
}
...
func ChannelsSetBoostsToUnblockRestrictions(ctx context.Context, m Requester, i ChannelsSetBoostsToUnblockRestrictionsRequest) (IUpdates, error) {
	var res IUpdates
	return res, request(ctx, m, &i, &res)
}
...
func ChannelsReportSponsoredMessage(ctx context.Context, m Requester, i ChannelsReportSponsoredMessageRequest) (IChannelsSponsoredMessageReportResult, error) {
	var res IChannelsSponsoredMessageReportResult
	return res, request(ctx, m, &i, &res)
}
...
func ChannelsRestrictSponsoredMessages(ctx context.Context, m Requester, i ChannelsRestrictSponsoredMessagesRequest) (IUpdates, error) {
	var res IUpdates
	return res, request(ctx, m, &i, &res)
}
...
func ChannelsSearchPosts(ctx context.Context, m Requester, i ChannelsSearchPostsRequest) (IMessagesMessages, error) {
	var res IMessagesMessages
	return res, request(ctx, m, &i, &res)
}
...
func ContactsGetBirthdays(ctx context.Context, m Requester, i ContactsGetBirthdaysRequest) (IContactsContactBirthdays, error) {
	var res IContactsContactBirthdays
	return res, request(ctx, m, &i, &res)
}
...
func FragmentGetCollectibleInfo(ctx context.Context, m Requester, i FragmentGetCollectibleInfoRequest) (IFragmentCollectibleInfo, error) {
	var res IFragmentCollectibleInfo
	return res, request(ctx, m, &i, &res)
}
...
func HelpGetTimezonesList(ctx context.Context, m Requester, i HelpGetTimezonesListRequest) (IHelpTimezonesList, error) {
	var res IHelpTimezonesList
	return res, request(ctx, m, &i, &res)
}
...
type MessagesSearchRequest struct {
	...
	SavedPeerID   IInputPeer  `tl:",omitempty:flags:2"`
	SavedReaction []IReaction `tl:",omitempty:flags:3"`
	TopMsgID      *int32      `tl:",omitempty:flags:1"`
	Filter        IMessagesFilter
	MinDate       int32
	MaxDate       int32
...
type MessagesSendMessageRequest struct {
	...
	QuickReplyShortcut     IInputQuickReplyShortcut `tl:",omitempty:flags:17"`
...
func MessagesAddChatUser(ctx context.Context, m Requester, i MessagesAddChatUserRequest) (IMessagesInvitedUsers, error) {
	var res IMessagesInvitedUsers
	return res, request(ctx, m, &i, &res)
}
...
func MessagesCreateChat(ctx context.Context, m Requester, i MessagesCreateChatRequest) (IMessagesInvitedUsers, error) {
	var res IMessagesInvitedUsers
	return res, request(ctx, m, &i, &res)
}
...
func MessagesGetDialogFilters(ctx context.Context, m Requester, i MessagesGetDialogFiltersRequest) (IMessagesDialogFilters, error) {
	var res IMessagesDialogFilters
	return res, request(ctx, m, &i, &res)
}
...
func MessagesRequestSimpleWebView(ctx context.Context, m Requester, i MessagesRequestSimpleWebViewRequest) (IWebViewResult, error) {
	var res IWebViewResult
	return res, request(ctx, m, &i, &res)
}
...
func MessagesRequestAppWebView(ctx context.Context, m Requester, i MessagesRequestAppWebViewRequest) (IWebViewResult, error) {
	var res IWebViewResult
	return res, request(ctx, m, &i, &res)
}
...
func MessagesGetSavedDialogs(ctx context.Context, m Requester, i MessagesGetSavedDialogsRequest) (IMessagesSavedDialogs, error) {
	var res IMessagesSavedDialogs
	return res, request(ctx, m, &i, &res)
}
...
func MessagesGetSavedHistory(ctx context.Context, m Requester, i MessagesGetSavedHistoryRequest) (IMessagesMessages, error) {
	var res IMessagesMessages
	return res, request(ctx, m, &i, &res)
}
...
func MessagesDeleteSavedHistory(ctx context.Context, m Requester, i MessagesDeleteSavedHistoryRequest) (IMessagesAffectedHistory, error) {
	var res IMessagesAffectedHistory
	return res, request(ctx, m, &i, &res)
}
...
func MessagesGetPinnedSavedDialogs(ctx context.Context, m Requester, i MessagesGetPinnedSavedDialogsRequest) (IMessagesSavedDialogs, error) {
	var res IMessagesSavedDialogs
	return res, request(ctx, m, &i, &res)
}
...
func MessagesGetSavedReactionTags(ctx context.Context, m Requester, i MessagesGetSavedReactionTagsRequest) (IMessagesSavedReactionTags, error) {
	var res IMessagesSavedReactionTags
	return res, request(ctx, m, &i, &res)
}
...
func MessagesGetDefaultTagReactions(ctx context.Context, m Requester, i MessagesGetDefaultTagReactionsRequest) (IMessagesReactions, error) {
	var res IMessagesReactions
	return res, request(ctx, m, &i, &res)
}
...
func MessagesGetOutboxReadDate(ctx context.Context, m Requester, i MessagesGetOutboxReadDateRequest) (IOutboxReadDate, error) {
	var res IOutboxReadDate
	return res, request(ctx, m, &i, &res)
}
...
func MessagesGetQuickReplies(ctx context.Context, m Requester, i MessagesGetQuickRepliesRequest) (IMessagesQuickReplies, error) {
	var res IMessagesQuickReplies
	return res, request(ctx, m, &i, &res)
}
...
func MessagesGetQuickReplyMessages(ctx context.Context, m Requester, i MessagesGetQuickReplyMessagesRequest) (IMessagesMessages, error) {
	var res IMessagesMessages
	return res, request(ctx, m, &i, &res)
}
...
func MessagesSendQuickReplyMessages(ctx context.Context, m Requester, i MessagesSendQuickReplyMessagesRequest) (IUpdates, error) {
	var res IUpdates
	return res, request(ctx, m, &i, &res)
}
...
func MessagesDeleteQuickReplyMessages(ctx context.Context, m Requester, i MessagesDeleteQuickReplyMessagesRequest) (IUpdates, error) {
	var res IUpdates
	return res, request(ctx, m, &i, &res)
}
...
func MessagesGetMyStickers(ctx context.Context, m Requester, i MessagesGetMyStickersRequest) (IMessagesMyStickers, error) {
	var res IMessagesMyStickers
	return res, request(ctx, m, &i, &res)
}
...
func MessagesGetEmojiStickerGroups(ctx context.Context, m Requester, i MessagesGetEmojiStickerGroupsRequest) (IMessagesEmojiGroups, error) {
	var res IMessagesEmojiGroups
	return res, request(ctx, m, &i, &res)
}
...
func MessagesGetAvailableEffects(ctx context.Context, m Requester, i MessagesGetAvailableEffectsRequest) (IMessagesAvailableEffects, error) {
	var res IMessagesAvailableEffects
	return res, request(ctx, m, &i, &res)
}
...
func MessagesEditFactCheck(ctx context.Context, m Requester, i MessagesEditFactCheckRequest) (IUpdates, error) {
	var res IUpdates
	return res, request(ctx, m, &i, &res)
}
...
func MessagesDeleteFactCheck(ctx context.Context, m Requester, i MessagesDeleteFactCheckRequest) (IUpdates, error) {
	var res IUpdates
	return res, request(ctx, m, &i, &res)
}
...
func MessagesGetFactCheck(ctx context.Context, m Requester, i MessagesGetFactCheckRequest) ([]IFactCheck, error) {
	var res []IFactCheck
	return res, request(ctx, m, &i, &res)
}
...
func MessagesRequestMainWebView(ctx context.Context, m Requester, i MessagesRequestMainWebViewRequest) (IWebViewResult, error) {
	var res IWebViewResult
	return res, request(ctx, m, &i, &res)
}
...
func PaymentsGetStarsTopupOptions(ctx context.Context, m Requester, i PaymentsGetStarsTopupOptionsRequest) ([]IStarsTopupOption, error) {
	var res []IStarsTopupOption
	return res, request(ctx, m, &i, &res)
}
...
func PaymentsGetStarsStatus(ctx context.Context, m Requester, i PaymentsGetStarsStatusRequest) (IPaymentsStarsStatus, error) {
	var res IPaymentsStarsStatus
	return res, request(ctx, m, &i, &res)
}
...
func PaymentsGetStarsTransactions(ctx context.Context, m Requester, i PaymentsGetStarsTransactionsRequest) (IPaymentsStarsStatus, error) {
	var res IPaymentsStarsStatus
	return res, request(ctx, m, &i, &res)
}
...
func PaymentsSendStarsForm(ctx context.Context, m Requester, i PaymentsSendStarsFormRequest) (IPaymentsPaymentResult, error) {
	var res IPaymentsPaymentResult
	return res, request(ctx, m, &i, &res)
}
...
func PaymentsRefundStarsCharge(ctx context.Context, m Requester, i PaymentsRefundStarsChargeRequest) (IUpdates, error) {
	var res IUpdates
	return res, request(ctx, m, &i, &res)
}
...
func PaymentsGetStarsRevenueStats(ctx context.Context, m Requester, i PaymentsGetStarsRevenueStatsRequest) (IPaymentsStarsRevenueStats, error) {
	var res IPaymentsStarsRevenueStats
	return res, request(ctx, m, &i, &res)
}
...
func PaymentsGetStarsRevenueWithdrawalURL(ctx context.Context, m Requester, i PaymentsGetStarsRevenueWithdrawalURLRequest) (IPaymentsStarsRevenueWithdrawalURL, error) {
	var res IPaymentsStarsRevenueWithdrawalURL
	return res, request(ctx, m, &i, &res)
}
...
func PaymentsGetStarsRevenueAdsAccountURL(ctx context.Context, m Requester, i PaymentsGetStarsRevenueAdsAccountURLRequest) (IPaymentsStarsRevenueAdsAccountURL, error) {
	var res IPaymentsStarsRevenueAdsAccountURL
	return res, request(ctx, m, &i, &res)
}

type PaymentsGetStarsTransactionsByIDRequest struct {
	Peer IInputPeer
	ID   []IInputStarsTransaction
}
...
func PaymentsGetStarsTransactionsByID(ctx context.Context, m Requester, i PaymentsGetStarsTransactionsByIDRequest) (IPaymentsStarsStatus, error) {
	var res IPaymentsStarsStatus
	return res, request(ctx, m, &i, &res)
}
...
type PaymentsGetStarsGiftOptionsRequest struct {
	_      struct{}   `tl:"flags,bitflag"`
	UserID IInputUser `tl:",omitempty:flags:0"`
}
...
func PaymentsGetStarsGiftOptions(ctx context.Context, m Requester, i PaymentsGetStarsGiftOptionsRequest) ([]IStarsGiftOption, error) {
	var res []IStarsGiftOption
	return res, request(ctx, m, &i, &res)
}
...
func SmsjobsIsEligibleToJoin(ctx context.Context, m Requester, i SmsjobsIsEligibleToJoinRequest) (ISmsjobsEligibilityToJoin, error) {
	var res ISmsjobsEligibilityToJoin
	return res, request(ctx, m, &i, &res)
}
...
func SmsjobsGetStatus(ctx context.Context, m Requester, i SmsjobsGetStatusRequest) (ISmsjobsStatus, error) {
	var res ISmsjobsStatus
	return res, request(ctx, m, &i, &res)
}
...
func SmsjobsGetSmsJob(ctx context.Context, m Requester, i SmsjobsGetSmsJobRequest) (ISmsJob, error) {
	var res ISmsJob
	return res, request(ctx, m, &i, &res)
}
...
func StatsGetBroadcastRevenueStats(ctx context.Context, m Requester, i StatsGetBroadcastRevenueStatsRequest) (IStatsBroadcastRevenueStats, error) {
	var res IStatsBroadcastRevenueStats
	return res, request(ctx, m, &i, &res)
}
...
func StatsGetBroadcastRevenueWithdrawalURL(ctx context.Context, m Requester, i StatsGetBroadcastRevenueWithdrawalURLRequest) (IStatsBroadcastRevenueWithdrawalURL, error) {
	var res IStatsBroadcastRevenueWithdrawalURL
	return res, request(ctx, m, &i, &res)
}
...
func StatsGetBroadcastRevenueTransactions(ctx context.Context, m Requester, i StatsGetBroadcastRevenueTransactionsRequest) (IStatsBroadcastRevenueTransactions, error) {
	var res IStatsBroadcastRevenueTransactions
	return res, request(ctx, m, &i, &res)
}
...
type StickersReplaceStickerRequest struct {
	Sticker    IInputDocument
	NewSticker IInputStickerSetItem
}
...
func StickersReplaceSticker(ctx context.Context, m Requester, i StickersReplaceStickerRequest) (IMessagesStickerSet, error) {
	var res IMessagesStickerSet
	return res, request(ctx, m, &i, &res)
}
...
type StoriesSearchPostsRequest struct {
	...
	Area    IMediaArea `tl:",omitempty:flags:1"`
	Offset  string
	Limit   int32
}
...
func StoriesSearchPosts(ctx context.Context, m Requester, i StoriesSearchPostsRequest) (IStoriesFoundStories, error) {
	var res IStoriesFoundStories
	return res, request(ctx, m, &i, &res)
}
